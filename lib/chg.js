...
/**
 * Finds a section by title in the changelog, and if it exists, returns the information
 ...
 * @returns {object} section.title - title of the section found
 * @returns {object} section.changes - changes in the section
 */
